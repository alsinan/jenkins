({
    doInit: function (component, event, helper) {
        ...
        var leadId = '5005h00000LYudNAAT';//component.get("v.leadId");
    ...
    sendMail: function (component, event, helper) {
        ...
        var leadId = '5005h00000LYudNAAT';//component.get("v.leadId");
        helper.sendHelper(component, 'alsinan@outlook.com', getSubject, getbody, leadId);
     ...
     preview: function (component, event, helper) {
        ...
        var leadId = '5005h00000LYudNAAT';//component.get("v.leadId");
         ...
         var action = component.get("c.previewMailMethod");
         var templateId = component.get("v.templateIDs");
         // set the 3 params to sendMailMethod method   
         action.setParams({
             'mMail': 'alsinan@outlook.com',
             'mSubject': getSubject,
             'mbody': getbody,
             'leadId': leadId,
         ...
         action.setCallback(this, function (response) {
             ...
             if (state === "SUCCESS") {
                 ...
                 component.set("v.htmlBody", storeResponse);
